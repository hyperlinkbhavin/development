                            ...
                            <form method="POST" action="{{ route('update_customer') }}" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="email" id="email" class="form-control" data-parsley-type="email"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5" style="margin-left: 20px !important">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="mobile" style="margin-top: -3px;" id="mobile" class="form-control" data-parsley-type="number"
                                                    value="{{ $user['mobile'] }}" data-parsley-maxlength="15" placeholder="Enter phone number"
                                                    data-parsley-required-message="This field is required" required>
