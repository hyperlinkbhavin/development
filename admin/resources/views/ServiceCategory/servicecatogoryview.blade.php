                ...
                <div class="col-lg-12 col-md-12 mt-5">
                    <div class="card member-card">
                        ...
                        <div class="body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h4 class="m-t-0"><b>Service Category Information</b></h4>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                        ...
                                        <div class="p-20">
                                            <div class="about-info-p">
                                                ...
                                                <div class="about-info-p">
                                                    <strong>Image</strong>
                                                    <br>
                                                    <img src="{{ "https://bawabat-dev-2.s3.me-central-1.amazonaws.com/bawabat/category/".$user->image }}" height="100px" width="120px"/>
                                                    
                                                    {{-- <img src="{{ asset('/resources/images/' . $user->image) }}" height="100px" width="100px"/> --}}
                                                   <br><br>
                                                    <strong>Number of Subcategory </strong>
                                                    <br>
                                                    <p class="text-muted" >{{$num_sub_cat->count()}}</p>   
                                                     <strong>Number of Providers </strong>
                                                    <br>
                                                    <p class="text-muted" >{{$provider->count()}}</p>
                                                    <strong>Number of Services </strong>
                                                    <br>
                                                    <p class="text-muted" >{{$service->count()}}</p><br><br>
                                            </div>
