        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 mt-5">
                    <div class="card">
                        <div class="header">
                            <h2> ADD SERVICE CATEGORY </h2><br>

                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('add_categories') }}" enctype="multipart/form-data"
                                ...
                                {{-- <input type="file" class="form-control" id="image" name="image"
                                    accept="image/png, image/jpeg, image/jpg" placeholder="upload image"
                                    data-parsley-required required multiple /> <span style="color: red">
                                    @error('image')
                                        {{ $message }}
                                    @enderror
                                </span><br> --}}

                                <span style="color: black">Note : file supported only jpeg,png,jpg format.</span><br><br>
                                {{-- <input type="file" class="form-control" id="image" name="image" value="{{old('image')}}" placeholder="upload image" data-parsley-required required multiple/> --}}
                                <br>
