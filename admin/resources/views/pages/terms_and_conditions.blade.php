        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 mt-5">
                <div class="card">
                    ...
                    <div class="header">
                        <h2>&nbsp; <small> Add And Update Terms & Conditions</small> </h2>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('update_page') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="hidden" name="page_keyword" value="{{$term->keyword}}">
                                <div class="form-group">
                                    <div class="col-sm-12" >
                                        <textarea required id="ckeditor" name="contents" class="form-control" rows="100" placeholder="Content">{{$term->content}}</textarea>
                                    </div>
                                </div>
                                <div class="text-center">
                                    ...
                                    <input type="submit" href="{{route('terms_and_condition')}}" class="btn btn-raised btn-primary m-t-15 waves-effect" style="background-color:#8f75d3;border:none;height:40px;width:80px" value="Submit"> 
                                </div>
                            </form>
                        </div>
                    </div>
